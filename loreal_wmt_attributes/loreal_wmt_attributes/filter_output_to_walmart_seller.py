...
WORKBOOK = BASE.parent / "lorealpi_product_verification_output_final.xlsx"
BACKUP = BASE.parent / "lorealpi_product_verification_output_final.backup-before-walmart-seller-filter.xlsx"
